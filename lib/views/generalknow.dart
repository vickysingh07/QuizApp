...
class GeneralKnow extends StatefulWidget {
  String quizID;
  int queMoney;
  GeneralKnow({required this.quizID, required this.queMoney});

  @override
  _GeneralKnowState createState() => _GeneralKnowState();
}

class _GeneralKnowState extends State<GeneralKnow> {
